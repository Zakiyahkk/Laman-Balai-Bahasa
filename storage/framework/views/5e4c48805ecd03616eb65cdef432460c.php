...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white p-6 sm:p-8 rounded-xl shadow-md w-full max-w-sm sm:max-w-md transition-all">
        ...
        <div class="flex justify-center mb-4">
            <img src="<?php echo e(asset('img/logo.png')); ?>" class="logo-admin w-auto transition-all">
        </div>
        ...
        <?php if($errors->has('login')): ?>
            <p class="text-red-500 mt-2 text-center text-sm"><?php echo e($errors->first('login')); ?></p>
        <?php endif; ?>

        <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>" class="form-login">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Laman-Balai-Bahasa\resources\views/admin/login.blade.php ENDPATH**/ ?>