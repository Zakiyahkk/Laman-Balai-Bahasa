        ...
        <div class="fasilitas-wrapper">
            ...
            <div class="fasilitas-slider" id="fasilitasSlider">
                ...
                <div class="fasilitas-card">
                    <img src="<?php echo e(asset('img/fasilitas-1.jpg')); ?>" alt="">
                ...
                <div class="fasilitas-card">
                    <img src="<?php echo e(asset('img/fasilitas-2.jpg')); ?>" alt="">
                    <div class="fasilitas-card-content">
                ...
                <div class="fasilitas-card">
                    <img src="<?php echo e(asset('img/fasilitas-3.jpg')); ?>" alt="">
                    <div class="fasilitas-card-content">
...
<?php /**PATH C:\laragon\www\Laman-Balai-Bahasa\resources\views/user/beranda/fasilitas.blade.php ENDPATH**/ ?>