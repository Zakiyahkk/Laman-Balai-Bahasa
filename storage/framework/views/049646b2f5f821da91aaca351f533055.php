...
<div class="mobile-header">
    <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo" class="mobile-logo">
...
<div class="header-main">
    <div class="container header-content">
        ...
        <div class="header-brand">
            <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo Kemdikbud">
        </div>
        ...
        <ul class="nav-menu" id="navMenu">
            ...
            <li class="nav-item dropdown <?php echo e(request()->is('profil*') ? 'active' : ''); ?>">
                ...
                <ul class="dropdown-menu">
                    <li class="<?php echo e(request()->is('profil/visi-misi') ? 'active' : ''); ?>">
                        <a href="<?php echo e(url('/profil/visi-misi')); ?>">Visi Dan Misi Balai Bahasa Provinsi Riau</a>
                    </li>
                    <li class="<?php echo e(request()->is('profil/tugas-dan-fungsi') ? 'active' : ''); ?>">
                        <a href="<?php echo e(url('/profil/tugas-dan-fungsi')); ?>">Tugas Pokok Dan Fungsi</a>
                    </li>
                    <li class="<?php echo e(request()->is('profil/kontak-kami') ? 'active' : ''); ?>">
                        <a href="<?php echo e(url('/profil/struktur-organisasi')); ?>">Struktur Organisasi</a>
                    </li>
                    <li class="<?php echo e(request()->is('profil/kontak-kami') ? 'active' : ''); ?>">
                        <a href="<?php echo e(url('/profil/pegawai')); ?>">Pegawai</a>
                    </li>
                    <li class="<?php echo e(request()->is('profil/kontak-kami') ? 'active' : ''); ?>">
                        <a href="<?php echo e(url('/profil/logo-bpp-riau')); ?>">Logo BPP Riau</a>
                    </li>
                    <li class="<?php echo e(request()->is('profil/kontak-kami') ? 'active' : ''); ?>">
                        <a href="<?php echo e(url('/profil/kontak-kami')); ?>">Kontak Kami</a>
                    </li>
                </ul>
            </li>
...
<?php /**PATH C:\laragon\www\Laman-Balai-Bahasa\resources\views/user/partials/header.blade.php ENDPATH**/ ?>