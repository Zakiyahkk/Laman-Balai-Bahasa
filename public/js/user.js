...
const mmData = [
    { type: "Yel-Yel", title: "Yel-Yel Balai Bahasa Riau", videoId: "Is1PyvA0MAU", desc: "Membawa pesan perubahan menuju Zona Integritas Wilayah Bebas dari Korupsi (ZI-WBK)." },
    { type: "Siniar", title: "RESAM BASTRA", videoId: "PhnYJL-LSx8", desc: "Membahas isu terkini mengenai perkembangan bahasa Indonesia dan sastra daerah di Riau." },
    { type: "Konten", title: "Kegiatan Balai Bahasa Riau", videoId: "5TAGi3OeScY", desc: "Upaya nyata dalam pelindungan dan pemasyarakatan bahasa di tengah masyarakat." }
];
...
window.loadContent = function(index) {
    ...
    if (frame) frame.src = "";
    if (thumb) thumb.src = `https://img.youtube.com/vi/${data.videoId}/maxresdefault.jpg`;
    ...
    if (textCont) {
        ...
        setTimeout(() => {
            ...
            document.getElementById("descText").innerHTML = `<p>${data.desc}</p>`;
            const badge = document.getElementById("badgeText");
            data.type === "Siniar" ? badge.classList.add("podcast") : badge.classList.remove("podcast");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    /* ==========================================================================
       ...
       ========================================================================== */
    if (typeof Swiper !== 'undefined' && document.querySelector(".tokohSlider")) {
    ...
    /* ==========================================================================
       ...
       ========================================================================== */
    if (typeof Swiper !== 'undefined' && document.querySelector(".mahkotaSwiper")) {
    ...
    if (menuToggle && bbpNavbar) {
        menuToggle.addEventListener("click", () => bbpNavbar.classList.toggle("mobile-open"));
    }
});
