    ...
    <div class="sticky-header-container">
        ...
        <div class="toolbar shadow-sm">
            <div class="search-wrapper">
                ...
                <input type="text" id="searchInput" class="form-control-custom" placeholder="Cari dokumen RENSTRA...">
            </div>
    ...
    <div class="info-box shadow-sm">
        ...
        <div>
            ...
            <div style="color: #1e40af; font-size: 13.5px; opacity: 0.9;">
                {{ strtoupper(str_replace('-', ' ', $tipe) ) }} merupakan dokumen perencanaan yang memuat visi, misi, tujuan, strategi, kebijakan, program dan kegiatan pembangunan sesuai dengan tugas dan fungsi.
        </div>
    </div>
</div>
