...
<div class="container-fluid py-3">
    ...
    <p class="page-description">Kelola dokumen Rencana Aksi yang merupakan turunan operasional dari Renstra</p>
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fw-bold">Monitoring Rencana Aksi Desember 2025</span>
                            </div>
                        </td>
                        <td class="text-muted small">Laporan monitoring pelaksanaan rencana aksi bulan Desember 2025</td>
                        <td class="text-secondary small">31 Desember 2025</td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="pdf-icon-bg"><i class="fas fa-file-pdf fs-5"></i></div>
                                <span class="fw-bold">Quick Wins Rencana Aksi 2026</span>
                            </div>
                        </td>
                        <td class="text-muted small">Program quick wins yang menjadi prioritas tinggi di tahun 2026</td>
    ...
    <div class="info-section shadow-sm">
        ...
        <div>
            ...
            <p class="text-dark mb-0 opacity-75" style="font-size: 14px; line-height: 1.6;">
                Rencana Aksi adalah dokumen yang memuat program dan kegiatan yang menjadi prioritas pembangunan tahunan beserta target dan indikator kinerjanya, merupakan penjabaran lebih detail dari Renstra.
            </p>
        </div>
    </div>
</div>
