    ...
    <div class="sticky-header-container">
        ...
        <div class="toolbar shadow-sm">
            <div class="search-wrapper">
                ...
                <input type="text" id="searchInput" class="form-control-custom" placeholder="Cari dokumen...">
            </div>
    ...
    <div class="table-card shadow-sm mt-3">
        <table class="table custom-table mb-0" id="documentTable">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="5" class="text-center py-5 text-muted">Belum ada data {{ strtoupper($tipe) }} tersedia.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <div class="pagination-wrapper">
            ...
            <nav>
                <ul class="pagination">
                    ...
                    @else
                        <li class="page-item"><a class="page-link" href="{{ $data->previousPageUrl() }}">Prev</a></li>
                    @endif
    ...
    <div class="info-box shadow-sm">
        ...
        <div>
            ...
            <div style="color: #1e40af; font-size: 13.5px; opacity: 0.9;">
                {{ strtoupper(str_replace('-', ' ', $tipe) ) }} merupakan sistem yang terintegrasi untuk mengelola dan memantau akuntabilitas kinerja instansi secara menyeluruh.
            </div>
        </div>
    </div>
</div>
