    ...
    <div class="sticky-header-container">
        ...
        <div class="toolbar shadow-sm">
            <div class="search-wrapper">
                ...
                <input type="text" id="searchInput" class="form-control-custom" placeholder="Cari dokumen PERJANJIAN KERJA...">
            </div>
    ...
    <div class="info-box shadow-sm">
        ...
        <div>
            ...
            <div style="color: #1e40af; font-size: 13.5px; opacity: 0.9;">
                {{ strtoupper(str_replace('-', ' ', $tipe) ) }} merupakan lembar/dokumen yang berisikan penugasan dari pimpinan instansi yang lebih tinggi kepada pimpinan instansi yang lebih rendah untuk melaksanakan program/kegiatan yang disertai dengan indikator kinerja.
            </div>
        </div>
    </div>
</div>
