...
<div class="container-fluid py-3">
    <div class="header-wrapper">
        ...
        <div class="header-title-box">
            <h3>DIPA (Daftar Isian Pelaksanaan Anggaran)</h3>
            <span class="header-subtitle">Menu Akuntabilitas</span>
        </div>
    </div>
    <p class="page-description">Kelola Daftar Isian Pelaksanaan Anggaran yang merupakan dokumen anggaran Satuan Kerja</p>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="pdf-icon-bg"><i class="fas fa-file-pdf fs-5"></i></div>
                                <span class="fw-bold">Review BIPA 2021-2025</span>
                            </div>
                        </td>
    ...
    <div class="info-section shadow-sm">
        ...
        <div>
            ...
            <p class="text-dark mb-0 opacity-75" style="font-size: 14px; line-height: 1.6;">
                DIPA merupakan dokumen pelaksanaan anggaran yang disusun oleh Pengguna Anggaran/Kuasa Pengguna Anggaran berdasarkan alokasi anggaran yang ditetapkan oleh Menteri Keuangan.
            </p>
        </div>
    </div>
</div>
