...
<div class="container-fluid py-3">
    <div class="header-wrapper">
        ...
        <div class="header-title-box">
            <h3>SAKAI (Sistem Aplikasi Keuangan dan Anggaran Internal)</h3>
            <span class="header-subtitle">Menu Akuntabilitas</span>
        </div>
    </div>
    <p class="page-description">Kelola dokumen terkait Sistem Aplikasi Keuangan dan Anggaran </p>
    ...
    <div class="info-section shadow-sm">
        ...
        <div>
            ...
            <p class="text-dark mb-0 opacity-75" style="font-size: 14px; line-height: 1.6;">
                SAKAI adalah sistem yang terintegrasi untuk mengelola dan memantau akuntabilitas kinerja instansi secara menyeluruh dan berkelanjutan, mencakup perencanaan, pelaksanaan, monitoring, dan evaluasi kinerja.
        </div>
    </div>
</div>
@endsection