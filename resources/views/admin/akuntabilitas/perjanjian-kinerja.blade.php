...
<div class="container-fluid py-3">
    ...
    <p class="page-description">Kelola dokumen Perjanjian Kinerja antara pimpinan dengan atasan langsung</p>
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fw-bold">Perjanjian Kinerja Tahun 2026</span>
                            </div>
                        </td>
                        <td class="text-muted small">Perjanjian kinerja organisasi untuk tahun anggaran 2026 dengan target dan indikator</td>
                        <td class="text-secondary small">10 Januari 2026</td>
                        <td><span class="badge-status status-review">Review</span></td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="pdf-icon-bg"><i class="fas fa-file-pdf fs-5"></i></div>
                                <span class="fw-bold">Laporan Capaian Perjanjian Kinerja 2025</span>
                            </div>
                        </td>
                        <td class="text-muted small">Laporan realisasi capaian perjanjian kinerja tahun 2025 secara keseluruhan</td>
                        <td class="text-secondary small">30 Desember 2025</td>
                        <td><span class="badge-status status-published">Published</span></td>
                        <td>
                            <div class="d-flex justify-content-center gap-3">
                                <a href="#" class="text-primary"><i class="far fa-edit"></i></a>
                                <a href="#" class="text-secondary"><i class="far fa-share-square"></i></a>
    ...
    <div class="info-section shadow-sm">
        ...
        <div>
            ...
            <p class="text-dark mb-0 opacity-75" style="font-size: 14px; line-height: 1.6;">
                Renstra merupakan dokumen perencanaan yang memuat visi, misi, tujuan, strategi, kebijakan, program dan kegiatan pembangunan sesuai dengan tugas dan fungsi organisasi untuk periode 5 tahun.Perjanjian Kinerja merupakan lembar/dokumen yang berisikan penugasan dari pimpinan instansi yang lebih tinggi kepada pimpinan instansi yang lebih rendah untuk melaksanakan program/kegiatan yang disertai dengan indikator kinerja.
            </p>
        </div>
    </div>
</div>
