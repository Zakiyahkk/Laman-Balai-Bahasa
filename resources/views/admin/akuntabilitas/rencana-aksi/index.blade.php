    ...
    <div class="sticky-header-container">
        ...
        <div class="toolbar shadow-sm">
            <div class="search-wrapper">
                ...
                <input type="text" id="searchInput" class="form-control-custom" placeholder="Cari dokumen RENCANA AKSI...">
            </div>
    ...
    <div class="info-box shadow-sm">
        ...
        <div>
            ...
            <div style="color: #1e40af; font-size: 13.5px; opacity: 0.9;">
                {{ strtoupper(str_replace('-', ' ', $tipe) ) }} merupakan dokumen yang memuat program dan kegiatan yang menjadi prioritas pembangunan tahunan beserta target dan indikator kinerjanya, merupakan penjabaran lebih detail dari Renstra.
        </div>
    </div>
</div>
