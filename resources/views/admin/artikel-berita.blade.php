...
<div class="d-flex min-vh-100">
    <aside class="sidebar d-flex flex-column">
        ...
        <div class="admin-profile p-3 mb-4">
            <div class="d-flex align-items-center">
                <img src="{{ asset('img/AkunLogo.jpg') }}" alt="Foto Profil Admin" class="avatar-circle me-3"> 
                <div>
        ...
        <ul class="nav flex-column menu-list flex-grow-1">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/publikasi') ? 'active' : '' }}" href="{{ url('/admin/publikasi') }}">
                    <i class="bi bi-book-fill me-2"></i> Publikasi
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/pendaftaran') ? 'active' : '' }}" href="{{ url('/admin/pendaftaran') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/halaman-web') ? 'active' : '' }}" href="{{ url('/admin/halaman-web') }}">
                    <i class="bi bi-globe me-2"></i> Halaman Web
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/pengaturan') ? 'active' : '' }}" href="{{ url('/admin/pengaturan') }}"> 
    ...
    {{-- MAIN CONTENT (KONTEN ARTIKEL & BERITA) --}}
    <main class="flex-fill p-4 bg-light">
        <div class="container-fluid">
            
            {{-- JUDUL & TOMBOL TAMBAH ARTIKEL (DIUBAH) --}}
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold">Artikel & Berita</h2>
                    <p class="text-muted">Kelola semua artikel dan berita</p>
                </div>
                {{-- PERUBAHAN: btn-lg menjadi btn-sm, dan btn-success menjadi btn-primary --}}
                <button class="btn btn-primary btn-sm d-flex align-items-center">
                    <i class="bi bi-plus me-2" style="font-size: 1.2rem;"></i> Tambah Artikel
                </button>
            </div>

            {{-- PENCARIAN & FILTER (DIUBAH) --}}
            <div class="row mb-4">
                {{-- PERUBAHAN: col-md-6 col-lg-4 diganti col-12 agar memanjang penuh --}}
                <div class="col-12">
