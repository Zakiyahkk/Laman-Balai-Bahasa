...
<div class="publication-card d-flex gap-4 mb-3"
     data-link="{{ route('admin.publikasi.show', 1) }}">
    ...
    <div class="publication-action">
        <a href="{{ route('admin.publikasi.edit', 1) }}"
...
<div class="publication-card d-flex gap-4 mb-4"
     data-link="{{ route('admin.publikasi.show', 2) }}">
    ...
    <div class="publication-action">
        <a href="{{ route('admin.publikasi.edit', 2) }}"
            class="btn btn-outline-secondary btn-sm"
            onclick="event.stopPropagation()">
                <i class="bi bi-pencil"></i>
        </a>
...
<!-- TERBIT - TERBARU -->
<div class="publication-card d-flex gap-4 mb-3"
     data-link="{{ route('admin.publikasi.show', 3) }}">
    ...
    <div class="publication-action">
        <a href="{{ route('admin.publikasi.edit', 3) }}"
            class="btn btn-outline-secondary btn-sm"
            onclick="event.stopPropagation()">
                <i class="bi bi-pencil"></i>
        </a>
...
<!-- TERBIT - LEBIH LAMA -->
<div class="publication-card d-flex gap-4 mb-3"
     data-link="{{ route('admin.publikasi.show', 4) }}">
    ...
    <div class="publication-action">
        <a href="{{ route('admin.publikasi.edit', 4) }}"
            class="btn btn-outline-secondary btn-sm"
            onclick="event.stopPropagation()">
                <i class="bi bi-pencil"></i>
        </a>
