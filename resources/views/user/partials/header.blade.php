    ...
    <div class="bbp-nav">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="{{ url('https://ppidbbpriau.kemendikdasmen.go.id/portal/tamu') }}"
                        class="{{ request()->is('sapa*') ? 'active' : '' }}"><i
                ...
                <li class="has-dropdown">
                    ...
                    <ul class="dropdown">
                        <li><a href="{{ url('/produk/terbitan-bbpr') }}"><i class="fa-regular fa-copy"></i> Terbitan
                                BBPR</a></li>
                        <li><a href="{{ url('https://madah.kemendikdasmen.go.id') }}"><i
                                    class="fa-regular fa-newspaper"></i> Jurnal
                                Madah</a>
                        </li>
                        <li><a href="{{ url('https://majalahserindit.kemendikdasmen.go.id') }}"><i
                                    class="fa-solid fa-book-open"></i> Majalah
                                Serindit</a></li>
                        <li><a href="{{ url('/produk/sembari') }}"><i class="fa-solid fa-gem"></i>
                                Sembari ( Serial Terjemahan BBPR)</a>
                        <li><a href="{{ url('https://sites.google.com/view/petapembinaanbahasa/halaman-muka') }}"><i
                        ...
                        <li><a href="{{ url('/produk/peta-pembinaan-sastra') }}"><i class="fa-solid fa-users"></i>
                                Silera (Sistem Informasi Komunitas Literasi Riau)</a>
                        </li>
                        <li><a href="{{ url('https://sapabipa.expert.web.id/') }}"><i
                                    class="fa-solid fa-globe-asia"></i> SAPA BIPA</a>
                        </li>
                    ...
                    <ul class="dropdown">
                        <li class="has-dropdown">
                            ...
                            <ul class="dropdown">
                                ...
                                <li class="has-dropdown">
                                    <a href="javascript:void(0)" onclick="toggleSub(this)">
                                        Penguatan Akuntabilitas <i
                                            class="fa-solid fa-chevron-right dropdown-arrow"></i>
                                    </a>
                                    <ul class="dropdown">
