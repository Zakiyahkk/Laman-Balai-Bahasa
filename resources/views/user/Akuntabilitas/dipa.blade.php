...
/* Matikan Hover Effect di Desktop */
.ak-card:hover, .ak-card:focus {
...
.ak-doc-card {
    margin-top: 14px;
    overflow: hidden; /* Agar border radius bottom terjaga */
}
...
/* =========================================
   MOBILE RESPONSIVE (DIPA)
   Layout: Card List (Label Kiri - Konten Kanan)
========================================= */
...
@section('content')
    ...
    <div class="ak-container ak-dipa-ui">
        ...
        <div class="ak-card ak-card-section">
            <div class="ak-section-title">Daftar Isian Pelaksanaan Anggaran (DIPA)</div>
            <div class="ak-section-subtitle">Daftar Isian Pelaksanaan Anggaran (DIPA)</div>
        </div>

        {{-- CARD 2: tools (search/filter) + tabel --}}
        <div class="ak-card ak-doc-card">

            <form class="ak-tools" method="GET" action="{{ url('/akuntabilitas/dipa') }}">
                <div class="ak-tools-row">
                    ...
                    @if (!empty($q) || !empty($selectedYear))
                        <a class="ak-btn ak-btn-ghost" href="{{ url('/akuntabilitas/dipa') }}">Reset</a>
                    @endif
                </div>
            </form>
